<h1 align="center">Hi 👋, I'm Vishakha Mishra</h1>
<h3 align="center">💻 Software Developer | Java & JavaScript Enthusiast | GenAI Explorer</h3>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Vishakhamishra2406&label=Profile%20Views&color=blueviolet&style=flat" alt="profile views" />
</p>

---

### 🧠 About Me
I'm a **detail-oriented Software Developer** skilled in **Java, JavaScript, and Python**, with hands-on experience in **Generative AI**, **web development**, and **real-world product building**.  
...
**Frameworks & Tools:** LangChain, Streamlit, Git, GitHub, VS Code, IntelliJ  
**Databases:** MySQL, Firebase  
**APIs:** Google Gemini API, LeetCode API, Weather API  
...
> Built with **Streamlit**, featuring intelligent text chunking and secure API handling.
...
> A modern **React e-commerce** web app using **Vite** and **Context API**.  
...
> Implemented with **HTML, CSS, JavaScript**, and optimized for all devices.
...
- 🧩 **LeetCode (400+ Problems Solved)**  
  - 250+ Easy | 140+ Medium  
  - Rating: 1556 | Top 30.47% globally | 57 contests attended  
  - [LeetCode Profile](https://leetcode.com/VishakhaM1624)

- 💻 **HackerRank Certifications**  
  - Java (4⭐), SQL (3⭐), Python (2⭐)  
...
- 🎭 **Drama Avenue (Navrang Club)** — Active performer in college stage events & skits.
